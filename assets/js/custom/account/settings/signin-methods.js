...
var KTAccountSettingsAppMethods_2 = {
  init: function () {
    var t, e;
    !(function () {
      var t = document.getElementById("kt_app2");
      if (t) {
        var e = document.getElementById("kt_app_edit2"),
          n = document.getElementById("kt_signin_password"),
          o = document.getElementById("kt_signin_password_edit"),
          i = document.getElementById("kt_app_button2"),
          s = document.getElementById("kt_app_cancel2"),
          r = document.getElementById("kt_signin_password_button"),
          a = document.getElementById("kt_password_cancel");
        i.querySelector("button").addEventListener("click", function () {
          l();
...
KTUtil.onDOMContentLoaded(function () {
  ...
  KTAccountSettingsAppMethods_2.init();
});
