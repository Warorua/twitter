...
<!-- authentication/layouts/fancy/sign-up.php 22:56:35 GMT -->
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="d-flex flex-stack py-2">
							...
							<div class="m-0">
								...
								<a href="sign-in.php" class="link-primary fw-bold fs-5" data-kt-translate="sign-up-head-link">Sign In</a>
							</div>
							<!--end::Sign Up link=-->
						</div>
						<!--end::Header-->
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="register.php" method="POST">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::Symbol-->
<?php 
$fb_url = 'http://localhost/twitter/auth/fb_2.php';
include './fb_1.php' ?>
										...
										<!--end::Symbol-->
															<!--begin::Symbol-->
<?php 
$tw_url = 'http://localhost/twitter/auth/sign-up.php';
