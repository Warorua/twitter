      ...
      o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach(
        (t) => {
          t.addEventListener("click", function (t) {
            ...
            Swal.fire({
              text: "Are you sure you want to hide " + r + "?",
              icon: "warning",
              showCancelButton: !0,
              buttonsStyling: !1,
              ...
              t.value
                ...
                : "cancel" === t.dismiss &&
                  Swal.fire({
                    text: customerName + " was not hidden.",
                    icon: "error",
                    buttonsStyling: !1,
                    confirmButtonText: "Ok, got it!",
                    customClass: { confirmButton: "btn fw-bold btn-primary" },
    ...
    l = () => {
      ...
      c.forEach((e) => {
        ...
        s.addEventListener("click", function () {
          Swal.fire({
            text: "Are you sure you want to hide selected users?",
            icon: "warning",
            showCancelButton: !0,
            buttonsStyling: !1,
            confirmButtonText: "Yes, hide!",
            ...
            t.value
              ? Swal.fire({
                  text: "You have hidden all selected users!.",
                  icon: "success",
                  buttonsStyling: !1,
                  confirmButtonText: "Ok, got it!",
                  customClass: { confirmButton: "btn fw-bold btn-primary" },
              ...
              : "cancel" === t.dismiss &&
                Swal.fire({
                  text: "Selected user was not hidden.",
                  icon: "error",
                  buttonsStyling: !1,
                  confirmButtonText: "Ok, got it!",
                  customClass: { confirmButton: "btn fw-bold btn-primary" },
