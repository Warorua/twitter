...
if (isset($_SESSION['consumer_key'])) {
	setcookie("consumer_key", $_SESSION['consumer_key'], time() + 60 * 60 * 24 * 30);

	setcookie("consumer_secret", $_SESSION['consumer_secret'], time() + 60 * 60 * 24 * 30);
...
<!-- authentication/layouts/fancy/sign-in.php 22:56:34 GMT -->
<!--  -->
				...
				<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
					...
					<div class="d-flex flex-stack py-2">
						...
						<div class="m-0">
							...
							<a href="sign-up.php" class="link-primary fw-bold fs-5" data-kt-translate="sign-in-head-link">Sign Up</a>
						</div>
						<!--end::Sign Up link=-->
					</div>
					<!--end::Header-->
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="verify.php" method="POST">
							...
							<div class="card-body">
								...
								<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-10">
									<div></div>
									<!--begin::Link-->
									<a href="reset-password.php" class="link-primary" data-kt-translate="sign-in-forgot-password">Forgot Password ?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Actions-->
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center">
										...
										<a href="<?php echo $url ?>" class="symbol symbol-circle symbol-45px w-45px bg-light me-3">
											<img alt="Logo" src="../assets/media/svg/brand-logos/twitter.svg" class="p-4" />
										</a>
										<!--end::Symbol-->
										<!--begin::Symbol-->
...
<!-- authentication/layouts/fancy/sign-in.php 22:56:35 GMT -->
