...
function api_shop_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function auto_dm_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function automation_scripts_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function automation_subs_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function bot_control_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function campaign_engine_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function client_api_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function engine_monitor_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function history_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function process_engine_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function pts_conversion_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function system_cookies_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function system_tokens_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function tester_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function tweet_factory_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function twitter_logs_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function usage_track_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function user_earnings_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function persist_expanded_child(id) {
	var expand_these = JSON.parse(localStorage.getItem('twitter.dvp_expand'));
	...
	if($j('[id=' + id + ']').hasClass('active')) {
		if(expand_these.indexOf(id) < 0) {
			...
			localStorage.setItem('twitter.dvp_expand', JSON.stringify(expand_these));
		}
	} else {
		if(expand_these.indexOf(id) >= 0) {
