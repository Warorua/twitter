                ...
                <form id="pointsRef">
                    <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                        ...
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Refill your points</h1>
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="nav-group nav-group-outline mx-auto" data-kt-buttons="true">
                                <button class="btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3 me-2 active" data-kt-plan="month">Gas Points Refill</button>
                                <!-- <button class="btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3" data-kt-plan="annual">Mega</button> --->
                            </div>
                            <!--end::Nav group-->
                            <!--begin::Row-->
                            <div class="row mt-10">
                                        ...
                                        <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 active mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="fw-semibold opacity-75">Get 1,000 points</div>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                            <!--end::Description-->
                                        ...
                                        <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_advanced">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="fw-semibold opacity-75">Get 4,000 points</div>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                            <!--end::Description-->
                                        ...
                                        <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_enterprise">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="fw-semibold opacity-75">Get 10,000 points</div>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                            <!--end::Description-->
                                        ...
                                        <label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_custom">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="fw-semibold opacity-75">Refill custom points</div>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                            <!--end::Description-->
                                    ...
                                    <div class="tab-content rounded h-100 bg-light p-10">
                                        ...
                                        <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                            ...
                                            <div class="pb-5">
                                                ...
                                                <div class="text-muted fw-semibold">Optimal for new startup users on a low budget</div>
                                            </div>
                                            <!--end::Heading-->
                                            <!--begin::Body-->
                                            <div class="pt-1">
                                        ...
                                        <div class="tab-pane fade" id="kt_upgrade_plan_advanced">
                                            ...
                                            <div class="pb-5">
                                                <h2 class="fw-bold text-dark">What’s in Startup Plan?</h2>
                                                <div class="text-muted fw-semibold">Optimal for recurrent users on a simple budget</div>
                                            </div>
                                            <!--end::Heading-->
                                            <!--begin::Body-->
                                            <div class="pt-1">
                                        ...
                                        <div class="tab-pane fade" id="kt_upgrade_plan_custom">
                                            ...
                                            <div class="pb-5">
                                                <h2 class="fw-bold text-dark">What’s in Startup Plan?</h2>
                                                <div class="text-muted fw-semibold">Optimal for corporates and high profile personel</div>
                                            </div>
                                            <!--end::Heading-->
                                            <!--begin::Body-->
                                            <div class="pt-1">
                        ...
                        <div class="d-flex flex-center flex-row-fluid pt-12">
                            ...
                            <button type="submit" class="btn btn-primary">Refill points</button>
                        </div>
                        <!--end::Actions-->
                    </div>
                </form>
