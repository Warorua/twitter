...
<div class="card card-flush h-xl-100 mb-5">
    ...
    <div class="card-header pt-7">
        ...
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800">Following</span>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                ...
                <tbody>
                    ...
                    <?php
                    if(count($following_list_data['data']) == 0){
                        echo '
                        <tr>
                         <td>
                         ...
                         <td class="text-end pe-0">
                             <span class="text-gray-600 fw-bold fs-6">'.number_format($following_list_data['data'][$i]['public_metrics']['followers_count']).'</span>
                         </td>
                         <td class="text-end pe-0">
                             <span class="text-danger fw-bold fs-6">'.number_format($following_list_data['data'][$i]['public_metrics']['following_count']).'</span>
                         </td>
                         <td class="text-end">
                     ...
                     <tr>
                     <td><span class="text-danger fw-bold fs-6">YOU DON\'T FOLLOW ANY ACCOUNT!</span></td>

                     </tr>
                         ';

                    }elseif(count($following_list_data['data']) < 10){
                        foreach($following_list_data['data'] as $row){
                        ...
                        <!--end::Svg Icon-->
                         ...
                         for($i = 0; $i<10; $i++){
                            if($following_list_data['data'][$i]['verified']){
                                $verif_icon_following = 'svg-icon-primary';
                                $verif_info_following = 'Twitter Verified';
                            }else{
                                $verif_icon_following = 'svg-icon-warning';
                       ...
                       <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="'.pic_fix($following_list_data['data'][$i]['profile_image_url']).'" class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <div class="text-gray-800 fw-bold  mb-1 fs-6">'.$following_list_data['data'][$i]['username'].'
                                    ...
                                    <span class="text-gray-400 fw-semibold d-block fs-7">'.$following_list_data['data'][$i]['name'].'</span>
                                </div>
                            </div>
                        </td>
                        <td class="text-end pe-0">
                        ...
                        <td class="text-end pe-0">
                            <span class="text-gray-600 fw-bold fs-6">'.number_format($following_list_data['data'][$i]['public_metrics']['following_count']).'</span>
                        </td>
                        <td class="text-end">
                            <a href="../public/feeds.php?user='.$following_list_data['data'][$i]['id'].'" target="_blank" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                                <span class="svg-icon svg-icon-5 svg-icon-gray-700">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M14.4 11H3C2.4 11 2 11.4 2 12C2 12.6 2.4 13 3 13H14.4V11Z" fill="currentColor" />
