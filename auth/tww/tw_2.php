...
//access token
if (isset($_GET['oauth_verifier'], $_GET['oauth_token']) && $_GET['oauth_token'] == $_SESSION['oauth_token']) {			   //In project use this session to change login header after successful login 
	$request_token = [];
