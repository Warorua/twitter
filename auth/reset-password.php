...
<!-- authentication/layouts/fancy/reset-password.html 22:56:35 GMT -->
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="d-flex flex-stack py-2">
							...
							<div class="m-0">
								...
								<a href="sign-in.php" class="link-primary fw-bold fs-5" data-kt-translate="password-reset-head-link">Sign In</a>
							</div>
							<!--end::Sign Up link=-->
						</div>
						<!--end::Header-->
							...
							<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" action="reset.php" method="POST">
								...
								<div class="d-flex flex-stack">
									...
									<div class="m-0">
										...
										<a href="sign-in.php" class="btn btn-lg btn-light-primary fw-bold" data-kt-translate="password-reset-cancel">Cancel</a>
									</div>
									<!--end::Link-->
								</div>
								<!--end::Actions-->
